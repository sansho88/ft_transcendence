...
// +---------------------------------------------------------------------+
	export namespace channel {
		...
		export const getAll = () => {
			return `${serverApi}/${routeChannels}/get`
		};
		export const getUsersChannel = (channelID: number) => {
			return `${serverApi}/${routeChannels}/get/list/${channelID}`
		};
		// export const getMsgsChannel = (channelID: number, timestamp: number)					=> {return `${serverApi}/${routeChannels}/get/${channelID}`};
		export const getChannelJoined = () => {
			return `${serverApi}/${routeChannels}/channelJoined`
		};
		export const getAllMessagesChannel = (channelID: number) => {
			return `${serverApi}/${routeChannels}/msg/${channelID}`
		};
		export const putModifChannel = (channelID: number) => {
			return `${serverApi}/${routeChannels}/modif/${channelID}`
		};
...
// +---------------------------------------------------------------------+
	...
	export const getMessagesByChannelId = () => {
		return `${serverApi}/${routeChannels}/`
	}; 	//all messages in channel_id

	export const postMessage = () => {
		return `${serverApi}/${routeMessages}`
	};

	export const putMessageById = () => {
		return `${serverApi}/${routeMessages}/`
	}; 			//feature ? 	params: message_id
